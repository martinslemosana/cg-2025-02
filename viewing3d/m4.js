var m4 = {
  ...
  setProjectionMatrix: function(xw_min,xw_max,yw_min,yw_max,z_near,z_far){
    return [
      2/(xw_max-xw_min), 0, 0, -(xw_max+xw_min)/(xw_max-xw_min),
      0, 2/(yw_max-yw_min), 0, -(yw_max+yw_min)/(yw_max-yw_min),
